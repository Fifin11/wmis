...
<head>
    ...
    <title>404 - Page Not Found | WMIS</title>
...
<body class="flex items-center justify-center min-h-screen text-slate-800">
    <div class="max-w-lg w-full text-center p-8 bg-white rounded-3xl shadow-2xl border border-emerald-100">
        ...
        <h1 class="text-5xl font-black text-emerald-600 mb-2">404</h1>
        <h2 class="text-2xl font-bold mb-4">Lost in the Zones?</h2>
        <p class="text-slate-500 mb-8">The page you are looking for has been moved, deleted, or never existed in our municipal database.</p>
