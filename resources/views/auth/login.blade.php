...
<body class="bg-emerald-50/50 min-h-screen flex items-center justify-center p-4 antialiased">
    ...
    <div class="bg-white rounded-3xl shadow-2xl overflow-hidden max-w-5xl w-full grid md:grid-cols-2 min-h-[600px] border border-emerald-100/50">
        ...
        <div class="bg-gradient-to-br from-emerald-800 via-emerald-900 to-teal-950 p-10 flex flex-col justify-between text-white relative">
            ...
            <div class="relative">
                ...
                <p class="text-emerald-100/80 text-sm mt-3 leading-relaxed max-w-md">
                    Smart Municipal Waste Logistics & Citizen Engagement Platform. Digitize collection routes, report dumpings, and participate in green gamification initiatives.
                </p>
            </div>
            
            <div class="border-t border-emerald-800/80 pt-8 relative">
                <p class="text-[10px] text-emerald-400 uppercase tracking-widest font-extrabold">Academic Project Submission</p>
        ...
        <div class="p-10 flex flex-col justify-center bg-white">
            <div class="mb-8">
                <h2 class="text-3xl font-black text-slate-800 tracking-tight">Portal Sign In</h2>
                <p class="text-slate-400 text-xs mt-1">Enter your municipal credentials or use the demo buttons below.</p>
            </div>
            ...
            <form action="{{ url('/login') }}" method="POST" class="space-y-5">
                ...
                <div>
                    <label class="block text-[10px] font-extrabold uppercase tracking-widest text-slate-500 mb-2">Email Address</label>
                ...
                <div>
                    <label class="block text-[10px] font-extrabold uppercase tracking-widest text-slate-500 mb-2">Password</label>
            ...
            <div class="mt-8 border-t border-slate-100 pt-6">
                <span class="block text-[9px] font-extrabold uppercase tracking-widest text-slate-400 mb-3">Quick Demo Authentication</span>
            ...
            <div class="mt-5 text-center">
                <a href="{{ route('citizen.dashboard') }}" class="text-xs font-semibold text-slate-450 hover:text-emerald-700 transition-colors">
                    🌍 Continue as Anonymous Citizen (Bypass)
                </a>
            </div>
        </div>
